...
parser.add_argument('--train_path', default='/home/ly/chz/ILSVRC2015/Data/VID/train/ILSVRC2015_VID_train_0000', metavar='DIR',help='path to dataset')

parser.add_argument('--weight_dir', default='/home/song/srpn/weight', metavar='DIR',help='path to weight')

parser.add_argument('--checkpoint_path', default='/home/ly/chz/weights-0690000.pth.tar', help='resume')
